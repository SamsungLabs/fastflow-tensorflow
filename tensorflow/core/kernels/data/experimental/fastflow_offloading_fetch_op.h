 ...
 * Copied from data_service_dataset_ops.h
 */
...
==============================================================================*/
#ifndef TENSORFLOW_CORE_KERNELS_DATA_EXPERIMENTAL_FASTFLOW_OFFLOADING_FETCH_OP_H_
#define TENSORFLOW_CORE_KERNELS_DATA_EXPERIMENTAL_FASTFLOW_OFFLOADING_FETCH_OP_H_
...
class FastflowOffloadingFetchOp : public DatasetOpKernel {
 public:
  ...
  static constexpr const char* const kPartialOffloadEnabled = "partial_offload_enabled";
  static constexpr const char* const kRatioLocal = "ratio_local";
  static constexpr const char* const kMaxBandwidthBps = "max_bandwidth_bps";
  ...
  explicit FastflowOffloadingFetchOp(OpKernelConstruction* ctx);
 ...
 private:
  ...
  bool partial_offload_enabled_;
  float ratio_local_;
  int64_t max_bandwidth_bps_;
};

}  // namespace data
}  // namespace tensorflow

#endif  // TENSORFLOW_CORE_KERNELS_DATA_EXPERIMENTAL_FASTFLOW_OFFLOADING_FETCH_OP_H_
