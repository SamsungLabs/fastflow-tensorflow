...
class OptionsDatasetOp : public DatasetOpKernel {
 public:
  ...
  static constexpr const char* const kAddressList = "address_list";
  static constexpr const char* const kThreadList = "thread_list";
  static constexpr const char* const kTargetThreadpoolSize = "target_threadpool_size";
 ...
 private:
  ...
  std::vector<tstring> address_list_;
  std::vector<int> thread_list_;
  int target_threadpool_size_;
};
