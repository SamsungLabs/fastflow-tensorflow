...
REGISTER_OP("DataServiceDataset")
    ...
    .Attr("partial_offload_enabled: bool = false")
    .Attr("ratio_local: float = 0.0")
    .SetIsStateful()
    .SetShapeFn(shape_inference::ScalarShape);
...
REGISTER_OP("FastflowOffloadingFetch")
        .Input("dataset_id: int64")
        .Input("processing_mode: string")
        .Input("address: string")
        .Input("protocol: string")
...
REGISTER_OP("FastflowOffloadingFetchV2")
        .Input("dataset_id: int64")
        .Input("processing_mode: string")
        .Input("address: string")
        .Input("protocol: string")
